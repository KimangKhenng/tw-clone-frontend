<template>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <svg class="mx-auto h-10 w-auto" viewBox="0 0 24 24" aria-hidden="true">
        <g>
          <path
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-2">
...
export default {
  ...
  // created() {
  //   //print env
  //   console.log(process.env.VUE_APP_ENV_GOOGLE_CALLBACK)
  //   console.log(process.env.VUE_APP_ENV_GOOGLE_CLIENT_ID)
  // },
  computed: {
  ...
  methods: {
    ...
    googleLogin() {
      const url = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.VUE_APP_ENV_GOOGLE_CLIENT_ID}&redirect_uri=${process.env.VUE_APP_ENV_GOOGLE_CALLBACK}&scope=profile email&response_type=code`;
